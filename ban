...
exports.run = (client, message, args) => {
  ...
  .addField(`:book: **Exemplo**`, `\`${c.prefix}ban @angelo Totoso\``, true)
  ...
  .setColor('#a67dff')  
       ...
       if (membro === message.member) return message.channel.send(` ⚒️ | **${message.author.username}**, você não se pode autobanir!`)
